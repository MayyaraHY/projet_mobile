class Voiture {
  ...
  factory Voiture.fromMap(Map<String, dynamic> map) {
    // Helper to safely parse numerics (SQLite may return ints or doubles)
    ...
    return Voiture(
      ...
      annee: parseInt(map['annee']),
      puissance: parseDouble(map['puissance']),
      cylindres: parseInt(map['cylindres']),
      carburant: (map['carburant'] ?? '') as String,
      kilometrage: parseDouble(map['kilometrage']),
